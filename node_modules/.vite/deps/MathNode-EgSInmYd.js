import { A as warnOnce, D as error, a as clamp$1, k as warn, l as euclideanModulo, m as lerp, n as MathUtils } from "./MathUtils-Ckv6EGMu.js";
...
//#endregion
//#region node_modules/three/src/nodes/math/OperatorNode.js
	...
	*/
	...
	generate(builder, output) {
		...
		if (type !== "void") {
			...
			else if (builder.isMatrix(typeB)) {} else typeA = typeB = type;
		...
		if (output !== "void") {
			...
			else if (op === "!") if (isGLSL && builder.isVector(typeA)) return builder.format(`not( ${a} )`, output);
...
//#endregion
//#region node_modules/three/src/nodes/math/MathNode.js
/**
...
var MathNode = class MathNode extends TempNode {
	...
	*/
	...
	setup(builder) {
		...
		let outputNode = null;
		if (method === MathNode.ONE_MINUS) outputNode = sub(1, aNode);
		else if (method === MathNode.RECIPROCAL) outputNode = div(1, aNode);
		else if (method === MathNode.DIFFERENCE) outputNode = abs(sub(aNode, bNode));
			...
			outputNode = normalize(mul(matrixNode, vec4(vec3(directionNode), 0)).xyz);
		}
...
* @type {Node<float>}
*/
var HALF_PI = /*@__PURE__*/ float(Math.PI * .5);
/**
...
* @returns {Node}
*/
var log = /*@__PURE__*/ nodeProxyIntent(MathNode, MathNode.LOG).setParameterLength(1);
/**
...
* @returns {Node}
*/
var log2 = /*@__PURE__*/ nodeProxyIntent(MathNode, MathNode.LOG2).setParameterLength(1);
/**
...
* @returns {Node}
*/
var normalize = /*@__PURE__*/ nodeProxyIntent(MathNode, MathNode.NORMALIZE).setParameterLength(1);
/**
...
* @returns {Node}
*/
var min = /*@__PURE__*/ nodeProxyIntent(MathNode, MathNode.MIN).setParameterLength(2, Infinity);
/**
...
* @returns {Node}
*/
var max = /*@__PURE__*/ nodeProxyIntent(MathNode, MathNode.MAX).setParameterLength(2, Infinity);
/**
...
*/
var transformNormalByViewMatrix = (normal, viewMatrix) => normalize(mul(viewMatrix, vec4(vec3(normal), 0)).xyz);
/**
...
*/
var transformNormalByInverseViewMatrix = (normal, viewMatrix) => normalize(vec4(vec3(normal), 0).mul(viewMatrix).xyz);
/**
...
* @returns {Node}
*/
var clamp = (value, low = 0, high = 1) => new MathNode(MathNode.CLAMP, nodeObject(value), nodeObject(low), nodeObject(high));
/**
...
* @returns {Node}
*/
var smoothstep = /*@__PURE__*/ nodeProxyIntent(MathNode, MathNode.SMOOTHSTEP).setParameterLength(3);
/**
...
* @returns {Node<float>}
*/
var rand = /*@__PURE__*/ Fn(([uv]) => {
	return fract(sin(mod(dot(uv.xy, vec2(12.9898, 78.233)), PI)).mul(43758.5453));
});
/**
...
//#endregion
export { pow3 as $, NodeShaderStage as $t, exp as A, mat3 as At, length as B, ArrayElementNode as Bt, dFdx as C, Fn as Ct, difference as D, float as Dt, determinant as E, defined as Et, fract as F, nodeObjects as Ft, min as G, hash as Gt, log as H, Node as Ht, fwidth as I, nodeProxy as It, negate as J, Vector2 as Jt, mix as K, hashString as Kt, inverse as L, vec3 as Lt, faceForward as M, nodeArray as Mt, faceforward as N, nodeImmutable as Nt, distance as O, getConstNodeType as Ot, floor as P, nodeObject as Pt, pow2 as Q, Matrix3 as Qt, inverseSqrt as R, vec4 as Rt, cross as S, trunc as St, degrees as T, bool as Tt, log2 as U, EventDispatcher as Ut, lengthSq as V, InputNode as Vt, max as W, getValueFromType as Wt, oneMinus as X, ColorManagement as Xt, normalize as Y, Vector3 as Yt, pow as Z, SRGBToLinear as Zt, cbrt as _, tanh as _t, PI as a, IntType as an, refract as at, cos as b, transformNormalByViewMatrix as bt, abs as c, MirroredRepeatWrapping as cn, sign as ct, all as d, RepeatWrapping as dn, smoothstep as dt, NodeUpdateType as en, pow4 as et, any as f, SRGBTransfer as fn, smoothstepElement as ft, atanh as g, tan as gt, atan as h, UnsignedIntType as hn, stepElement as ht, MathNode as i, FloatType as in, reflect as it, exp2 as j, mat4 as jt, dot as k, int as kt, acos as l, NearestFilter as ln, sin as lt, asinh as m, UnsignedByteType as mn, step as mt, HALF_PI as n, ClampToEdgeWrapping as nn, rand as nt, PI2 as o, LinearFilter as on, round as ot, asin as p, StaticDrawUsage as pn, sqrt as pt, mixElement as q, StackTrace as qt, INFINITY as r, Compatibility as rn, reciprocal as rt, TWO_PI as s, LinearMipmapLinearFilter as sn, saturate as st, EPSILON as t, vectorComponents as tn, radians as tt, acosh as u, RGBAFormat as un, sinh as ut, ceil as v, transformDirection as vt, dFdy as w, addMethodChaining as wt, cosh as x, transpose as xt, clamp as y, transformNormalByInverseViewMatrix as yt, inversesqrt as z, TempNode as zt };
